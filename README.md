...
Full-featured mobile client for OpenClaw — AI chat, kanban board, secrets vault, security scanner, and more.
...
- **📋 Kanban Board** — Drag-and-drop task management, syncs with web kanban
