...
- [ ] **Implement task board sync** — Currently stubbed functions
...
- [ ] Show card created/updated dates in task board
- [ ] Validate gateway URL format
- [ ] Add message pagination
- [ ] Card virtualization for large boards
- [ ] Long-press hint for task board cards
...
src/store/task board.ts         # Logger
...
4. **Implement task board sync** or remove claim (HIGH)
